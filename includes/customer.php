					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner mt-4">
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Kunal Jain</strong></h5>
							...
							<div class="carousel-item text-center">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Ritvuk Shrama</strong></h5>
								<h6 class="text-dark m-0">Sangli</h6>
								<p class="m-0 pt-3">Guys if u want hangout with u r friends and 
									family then this place is awesome staff also good.
								 	for trek this place is best and also for refresh your employees . 
									we can not express the natural beauty in words.</p>
							</div>
							<div class="carousel-item text-center">
								<div class="img-box p-1 border rounded-circle m-auto">
									<img class="d-block w-100 rounded-circle" src="images/profile-3.jpg" alt="">
								</div>
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Ruhhi Shetty</strong></h5>
